...
public class PlaceIrrigationTileCommand implements GameplayActionCommand {
    ...
    public PlaceIrrigationTileCommand(TurnController controller, TileComponent tile, Space space, SharedResources resources){
    ...
    public void execute() {
        ...
        resources.decNumIrrigationTiles();
    ...
    public void undo() {
        ...
        space.placeTile(tile);
        //update resource counter
        resources.incNumIrrigationTiles();
        //update dat turn counter
