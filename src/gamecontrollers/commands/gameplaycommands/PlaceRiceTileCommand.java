...
public class PlaceRiceTileCommand implements GameplayActionCommand{
    ...
    public PlaceRiceTileCommand(TurnController controller, TileComponent tile, Space space){
    ...
    public void execute() {
        ...
        controller.getCurrentPlayer().playRice();
    ...
    public void undo() {
        ...
        space.removeTile();
        //update player counter
        controller.getCurrentPlayer().returnRice();
        //update dat turn counter
